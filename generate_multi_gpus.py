...
def main(args, cfg):
    ...
    project_dir = "test_nuScenes_0329"
...
if __name__ == "__main__":
    ...
    root_path = "/ihoment/youjie10/qwt/model/T2LDM-final"
    dataset = "nuScenes" #nuScenes, KITTI360, SemanticKITTI
    task = f"unconditional_{dataset}_gn"
    log = "20260325T160350"
