...
class TrainingConfig:
    ...
    n_attn_types = ["nn", "nn", "nn", "nn"] # ["nn", "nn", "nn", "nn"] # ["linear", "linear", "linear", "vanilla"]
    n_norm_types = ["ln", "ln", "ln", "ln"] # ["ln", "ln", "ln", "ln"] # ["gn", "gn", "gn", "gn"]
    n_use_norm = [True, True, True, True]
    n_use_res_connection = [True, True, True, True]
    n_heads = [2, 4, 8, 8]

    n_midd_attn_type: str = 'nn' # 'nn' # 'vanilla'
    n_midd_norm_type: str = 'ln' # 'ln' # 'gn'
    ...
    freeze_guidence_net: bool = True
    attention_gate: str = False # "head" "element" False

    use_text: bool = True # Text-Guidance
    ...
    save_sample_steps: int =  5_000# 5_000 # 10_000 # 1
    save_model_steps: int =  5_000 # 1
    gradient_accumulation_steps: int = 1
    lr: float = 2e-4 # 1e-4， 1e-5(效果一般)
    ...
    filer_keys =  ["g_",] # ["n_","temb","g_",] # None
    checkpoint_dir: str = None
    pretrained_checkpoint_dir: str = "logs/diffusion/text_nuScenes_gn/20260331T070054/models/diffusion_0000100000.pth"
    # ---- training setting ----
    ...
    diffusion_guidence_weights = [0.0001, 0.0001, 0.0001, 0.0001]
