...
class TrainingConfig:
    ...
    pretrained_checkpoint_dir: str = "/ihoment/youjie10/qwt/model/checkpoints/unconditional_nuscenes/unconditional_nuScenes_full_training_scrg/4_3090_780000.pth"
    # ---- training setting ----
