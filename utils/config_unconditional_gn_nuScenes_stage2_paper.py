...
class TrainingConfig:
    ...
    pretrained_checkpoint_dir: str = "/data/qwt/models/ControlLidar_aimax-1125/logs/diffusion/unconditional_gn_nuScenes_stage1_paper/20251205T014904/models/diffusion_0000100000.pth"
    # ---- training setting ----
    ...
    diffusion_guidence_step_interval: int = 100_000 #33_333
