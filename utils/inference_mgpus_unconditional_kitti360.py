...
# from utils.config_unconditional_gn_kitti360_stage2 import TrainingConfig
from utils.config_unconditional_kitti360 import TrainingConfig
...
def setup_model(
    ...
    if cfg.model_name == "circular_unet":
        model = CircularUNet(
            ...
            dropout=cfg.dropout,
            resamp_with_conv=cfg.resamp_with_conv,
