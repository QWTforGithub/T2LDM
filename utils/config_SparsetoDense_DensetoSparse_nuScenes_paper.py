...
class TrainingConfig:
    ...
    pretrained_checkpoint_dir: str = "/data/qwt/models/ControlLidar_aimax-1125/logs/diffusion/nuScenes/spherical-1024/20251129T192752/models/diffusion_0000000001.pth"
    # ---- training setting ----
