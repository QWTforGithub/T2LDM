...
class TrainingConfig:
    ...
    num_steps: int = 2_000_000 # 400_000
    ...
    checkpoint_dir: str = "/ihoment/youjie10/qwt/model/ControlLidar_aimax-1125/logs/diffusion/unconditional_nuScenes/20251230T165346/models/diffusion_0000800000.pth"
