...
class TrainingConfig:
    ...
    use_circularconv_shortcut: bool = False

    use_guidence_net: bool = True
    use_control_net: bool = False
    freeze_guidence_net: int = True
    ...
    pretrained_checkpoint_dir: str = "/data/qwt/models/ControlLidar_aimax-1125/logs/diffusion/unconditional_nuScenes/20251130T204729/models/diffusion_0000000001.pth"
    # ---- training setting ----
    ...
    diffusion_classifier_free_scale: float = 4.0  # 4.0
