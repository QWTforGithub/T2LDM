...
class SCRGLossWeight():
    ...
    def get_loss_weight(self, current_step):
        if(current_step // self.step_interval < len(self.weights)):
            weight =  self.weights[current_step // self.step_interval]
        else:
...
if __name__ == '__main__':
    ...
    # # 多方向
    # root_path = "/data/qwt/models/ControlLidar_aimax/test2/20251104T033235_400000_1024_text_True_nuscenes_seed_0/plys"
    # file_path = "/data/qwt/models/FSHNet-main/tools/test/20251104T041105/eval/epoch_36/val/default/result.pkl"
    #
    # root_path = "/data/qwt/models/ControlLidar_aimax/test2/20251101T022111_800000_1024_kitti360_text_False/plys"
    # file_path = "/data/qwt/models/FSHNet-main/tools/test/20251106T201249/eval/epoch_36/val/default/result.pkl"
    #
    # root_path = "/data/qwt/temp/ours_nuscenes"
    # file_path = "/data/qwt/models/FSHNet-main/tools/test/20251106T203429/eval/epoch_36/val/default/result.pkl"
    #
    # # root_path = "/data/qwt/models/ControlLidar_aimax/test2/20251106T192448_400000_1024_text_True_nuscenes_seed_0/plys"
    # # file_path = "/data/qwt/models/FSHNet-main/tools/test/20251106T193630/eval/epoch_36/val/default/result.pkl"
    #
    # # root_path = "/data/qwt/models/ControlLidar_aimax/test2/20251104T015147_400000_1024_text_True_nuscenes_seed_0/plys"
    # # file_path = "/data/qwt/models/FSHNet-main/tools/test/20251104T025834/eval/epoch_36/val/default/result.pkl"
    # #
    # #
    # # root_path = "/data/qwt/models/ControlLidar_aimax/test2/20251106T072831_400000_1024_text_True_nuscenes_seed_244/plys"
    # # file_path = "/data/qwt/models/FSHNet-main/tools/test/20251106T080818/eval/epoch_36/val/default/result.pkl"
    #
    # save_path = "/data/qwt/temp/best_nusc"
    #
    # with open(file_path, 'rb') as f:   # 'rb' 表示以二进制读取
    ...
    #             objects += 1
    #
    #     # text_path = f"{root_path}/{id}.pkl"
    #     # text = read_pkl(text_path)
    #     # text = decode_tensor(text)[0]
    #     # print(text)
    #
    #
    #     if(objects == 0):
    #         print(f"{objects}, {id}")
    #         shutil.copy(src=f"{root_path}/{id}.ply", dst=f"{save_path}/{id}.ply")
    #
    #     # if(objects > 5):
    #     #     print(f"{objects}, {id}")
    #     #     if(text.__contains__("More ")):
    #     #         acc_num += 1
    #     #     shutil.copy(src=f"{root_path}/{id}.ply", dst=f"{save_path}/{id}.ply")
    #     # elif(objects < 5):
    #     #     if(text.__contains__("Less ")):
    #     #         acc_num += 1
    #
    #     # key = None
    #     # for key in keys:
    ...
    #     #         break
    #
    #     # if(names.__contains__(key) and names.__contains__("car")):
    #     #     print(f"{objects}, {id}, {text}")
    #     #     shutil.copy(src=f"{root_path}/{id}.ply", dst=f"{save_path}/{id}.ply")
    #     #     acc_num += 1
    #
    #     # if (names.__contains__("pedestrian") and names.__contains__("car")):
    #     #     print(f"{objects}, {id}, pedestrian")
    #     #     shutil.copy(src=f"{root_path}/{id}.ply", dst=f"{save_path}/{id}_pedestrian.ply")
    #     # elif(names.__contains__("barrier") and names.__contains__("car")):
    #     #     print(f"{objects}, {id}, barrier")
    #     #     shutil.copy(src=f"{root_path}/{id}.ply", dst=f"{save_path}/{id}_barrier.ply")
    #     # elif(names.__contains__("truck") and names.__contains__("car")):
    #     #     print(f"{objects}, {id}, truck")
    #     #     shutil.copy(src=f"{root_path}/{id}.ply", dst=f"{save_path}/{id}_truck.ply")
    #
    # print(acc_num / len(results))

    # f1 = "/data/qwt/models/ControlLidar_aimax/upsampling/baseline.ply"
    # f2 = "/data/qwt/models/ControlLidar_aimax/upsampling/input.ply"
    # test_mid(target_path=f1, save_path=f2, rate=0.25)

    f1 = "/data/qwt/models/ControlLidar_aimax/upsampling/reference2.ply"

    points = read_ply(f1)
    points = torch.from_numpy(points).unsqueeze(0).permute(0,2,1).float().cuda()

    # points_input = FPS(points, 8192)
    # points_input = points_input.cpu().permute(0,2,1).squeeze().numpy()
    # pc = open3d.geometry.PointCloud()
    # pc.points = open3d.utility.Vector3dVector(points_input)
    # open3d.io.write_point_cloud(filename="/data/qwt/models/ControlLidar_aimax/upsampling/points_input.ply", pointcloud=pc)

    points_4_input = FPS(points, 32768)
    points_4_input = points_4_input.cpu().permute(0, 2, 1).squeeze().numpy()
    pc = open3d.geometry.PointCloud()
    pc.points = open3d.utility.Vector3dVector(points_4_input)
    open3d.io.write_point_cloud(filename="/data/qwt/models/ControlLidar_aimax/upsampling/points_4_input2.ply", pointcloud=pc)


    # points_8_input = FPS(points, 65536)
    # points_8_input = points_8_input.cpu().permute(0, 2, 1).squeeze().numpy()
    # pc = open3d.geometry.PointCloud()
    # pc.points = open3d.utility.Vector3dVector(points_8_input)
    # open3d.io.write_point_cloud(filename="/data/qwt/models/ControlLidar_aimax/upsampling/points_8_input.ply", pointcloud=pc)
