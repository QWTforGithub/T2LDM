...
class TrainingConfig:
    ...
    diffusion_classifier_free_scale: float = None# 4.0 # None  # 4.0
    diffusion_classifier_dropout: float = 0.0#0.1 #0.0 # 0.1
    # ---- diffusion setting ----
