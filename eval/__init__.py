...
from eval.models.rangenet.model import Model as rangenet

try:
    from eval.models.spvcnn.model import Model as spvcnn
    from eval.models.minkowskinet.model import Model as minkowskinet
except:
...
def build_model(dataset_name, model_name, device='cpu'):
    ...
    if model_name != 'rangenet':
        config = common.dict2namespace(config)
