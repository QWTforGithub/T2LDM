...
This repo is the official project repository of the paper **_A Self-Conditioned Representation Guided Diffusion Model for Realistic Text-to-LiDAR Scene Generation_**. 
 ...
 - **_The code wiil further be updated for KITTI360 and SemanticKITTI!_**
...
## Model Zoo
We create a Huggingface project for [T2LDM](https://huggingface.co/QWTforHuggingFace/T2LDM/tree/main). Please download something from Huggingface.<br/>
<br/>
